...
if __name__ == '__main__':
	...
	# cnn_ft = np.empty([d.shape[0], 4096])
	...
	# 	cnn_ft[index, ] = net.blobs['fc7'].data[0]
	...
	# np.save(open("cnn_ft.npy", 'wb'), cnn_ft)

	test_image = "/Users/tj474474/Development/visual_database/amazon/crawlImages/16449.jpg"
	image = caffe.io.load_image(test_image)
	net.blobs['data'].data[...] = transformer.preprocess('data', image)

	# perform classification
	net.forward()
	query_ft = net.blobs['fc7'].data[0]

	cnn_ft = np.load("cnn_ft.npy")
