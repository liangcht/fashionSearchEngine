...
model_def = '/home/ubuntu/fine_tune_VGG/deploy.prototxt'
...
model_weights = "/home/ubuntu/data/LR001_tune_all_iter_999.caffemodel"
...
def getMatrix():
	...
	engine = create_engine('sqlite:///test_large_no_noise.db')
	...
	for index, path in enumerate(d["path"].values):
		...
		my_image_url = "/home/ubuntu/data/cropImage_large/crop"
	...
	np.save(open("/home/ubuntu/data/crop_cnn_prob_large_fine_VGG500.npy", 'wb'), cnn_ft)
